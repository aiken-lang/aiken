    ...
    fn simplified_hydra() {
        assert_validator(
            ...
            json!({
              ...
              "hash": "ff5b503bbcd7ed5fca26e803d69c09413bef905e72575443557f5a91",
              "definitions": {
                "ByteArray": {
                  "dataType": "bytes"
                },
    ...
    fn generics() {
        assert_validator(
            ...
            json!({
              ...
              "hash": "f45ef7cb07467b7bd4cbad2e5feecfd30ed5194b50026aba04a6692a",
              "definitions": {
                "ByteArray": {
                  "dataType": "bytes"
                },
    ...
    fn recursive_types() {
        assert_validator(
            ...
            json!({
              ...
              "hash": "dafa047eb117e2b4df02e3c3d500faf6164ffc10c6ef9405cfd77bbb",
              "definitions": {
                "Int": {
                  "dataType": "integer"
                },
    ...
    fn recursive_generic_types() {
        assert_validator(
            ...
            json!({
              ...
              "hash": "be815f61a39a2cb454eb24986ee22a14e5802d08ab83ea8cd4382651",
              "definitions": {
                "Bool": {
                  "title": "Bool",
                  "anyOf": [
